...
Find NPP and Aridity data for GROW watersheds (PRISM data already in StreamCat dataset).
...
whondrs_db <- read_csv('data/grow/WHONDRS_S19S_Metadata_v3.csv') %>%
  ...
  filter(!Sample_ID %in% c("S19S_0038", "S19S_0037", "S19S_0098", "S19S_0097", 
                           ...
                           "S19S_0027", "S19S_0032")) %>% # sites with a listed discharge, but don't actually have discharge (typically these have only stage the procided links are broken, or the flow data doesn't seem to exist).
